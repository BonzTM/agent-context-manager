...
- `operation` (one of `get_context`, `fetch`, `propose_memory`, `report_completion`, `review`, `work`, `history_search`, `sync`, `health_check`, `health_fix`, `coverage`, `eval`, `verify`, `bootstrap`)
