...
| Feature-planning contract | `docs/feature-plans.md`, `scripts/acm-feature-plan-validate.py`, `.acm/acm-tests.yaml`, maintainer guidance | `AGENTS.md`, examples or templates that mention feature planning | `python3 scripts/acm-feature-plan-validate.py --help`, then `acm verify` on a feature-plan task |
