...
7. Use `/acm-memory ...` for durable decisions and gotchas, including evidence from effective scope and preferring governed `evidence_paths` unless exact fetched keys are already available.
