...
append_line "Before closing verify-sensitive work, run acm verify, then acm review --run when the workflow requires it, then acm done. Save reusable decisions with amm_remember."
